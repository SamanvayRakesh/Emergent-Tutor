...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Every AI interaction uses credits: chatting with your tutor uses 1–5 credits, quizzes use 8 credits. You earn bonus credits by completing quizzes and maintaining streaks.',
    items: [
      { label: 'AI Tutor chat', cost: '1–5 credits / message' },
      { label: 'Generate a Quiz', cost: '8 credits' },
      { label: 'Earn credits', cost: '+5 XP per chat response' },
    ],
